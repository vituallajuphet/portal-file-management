                                                        ...
                                                        <tbody>
                                                            <tr v-for="req in request_files" :class="get_status_class(req.request_status)" v-if="req.request_status != 'Restricted'">
                                                                ...
                                                                <a class="view_request_details act_btn" :data="req.request_id" href="javascript:;" @click="view_request_details(req.request_id)" title="View Details" ><i class="fa fa-eye"></i></a>
                                                                    <a class="show_approve_request_frm act_btn" :data="req.request_id" @click="show_approve_request_frm(req.request_id)" href="javascript:;" title="Upload file to approve"><i class="fas fa-upload"></i></a>
                                                                    <!-- <a class="act_btn" style="cursor:not-allowed" v-else-if="req.request_status == 'Pending'" href="javascript:;" title="Upload file to approve"><i class="fas fa-edit"></i></a> -->
