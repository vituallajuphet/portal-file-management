									...
									<div class="col-md-3">
										<div class="proCont">
											...
											<div class="prof protxt">
												...
												<span class="profile_usertype">Subsidiary User</span>
											</div>
										</div>
										<div class="cont-prof">
											...
											<ul>
												...
												<li>Companies: 
                                                    <span style="display:block;" v-for="(comp, index) in companies">{{comp.company_name}}{{(companies.length > index + 1 ? ', ': '')}} </span>
                                                </li>
														...
														<div class="col-md-4">
															<div class="form-group">
																...
																<input type="text" required
																	...
																	placeholder="User type" value="Subsidiary User">
															</div>
														</div>
														<div class="col-md-4">
															<div class="form-group">
