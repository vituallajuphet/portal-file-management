                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >{{selected_completed_file.file_title}}</div>
                            </div>
                        </div>    
                        <div class="col-md-6">
                            <div class="form-group">
                                <label  class="control-label f-bold">Status:</label>
                                <div >{{selected_completed_file.request_status}}</div>
                            </div>
                        </div>  
                        <div class="col-md-6">
                            <div class="form-group">
                                <label  class="control-label f-bold">Company Name:</label>
                                <div >{{selected_completed_file.company_name}}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label  class="control-label f-bold">Department:</label>
                                <div >{{selected_completed_file.department}}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label  class="control-label f-bold">Requested Date:</label>
                                <div >{{selected_completed_file.requested_date}}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label  class="control-label f-bold">Approved Date:</label>
                                <div >{{selected_completed_file.date_approved}}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >{{selected_completed_file.firstname +' '+selected_completed_file.lastname}}</div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
