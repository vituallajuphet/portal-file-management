                                ...
                                <tbody>
                                    <tr v-for="comp in activeCompanies">
                                        ...
                                        <td class="td-manage-user">
                                            <a href="javascript:;" :data="comp.company_id" class="show_details_modal" style="color:black" @click="show_details_modal(comp.company_id)" title="View Details"><i class="fas fa-eye"></i></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
