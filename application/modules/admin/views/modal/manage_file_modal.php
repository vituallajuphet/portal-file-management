<div id="file_modal" class="modal show dept_modal file-modal" tabindex="-1" role="dialog" aria-labelledby="vcenter"  aria-modal="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-form ">
            <form action="<?=base_url("admin/save_file_data")?>" id="frm_add_file" @submit.prevent="submit_add_form()" method="POST" enctype="multipart/form-data">
...
<div id="file_edit_modal" class="modal show dept_modal file-modal" tabindex="-1" role="dialog" aria-labelledby="vcenter"  aria-modal="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-form ">
            <form action="<?=base_url("admin/update_file_data")?>" id="frm_edit_file" @submit.prevent="submit_edit_form()" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
