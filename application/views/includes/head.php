                                            ...
                                            <?php 
                                                ...
                                                if(empty($notifications)){
                                                    ...
                                                    foreach ($notifications as $notify) {
                                                        ...
                                                        ?>
                                                            <a href="<?= base_url("investor/notifications/view/".$notify->notify_id)?>" class="noti-cont <?=$readClass?>">
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li> <a class="waves-effect waves-dark" href="<?= base_url("investor/dashboard")?>" aria-expanded="false"><i class="icon-Dashboard"></i><span class="hide-menu">Dashboard </span></a></li>
                        <li class="active"> <a class="waves-effect waves-dark active" href="<?= base_url()."investor/files" ?>" aria-expanded="false"><i class="icon-Files"></i><span class="hide-menu">Files </span></a>
                        </li>
                         <li> <a class="waves-effect waves-dark" href="<?= base_url()."investor/manage_request" ?>" aria-expanded="false"><i class="icon-File-HorizontalText"></i><span class="hide-menu">Manage Request</span></a>
                        </li>
